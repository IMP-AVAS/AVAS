...
if __name__ == "__main__":
    ...
    origin_project_path = {"base_dir": r"C:\Users\wangh\Desktop\ea_test\AVAS\EA_CAFe_MEBT\base_dir",
                           "field_dir": r"C:\Users\wangh\Desktop\ea_test\AVAS\EA_CAFe_MEBT\field_dir",
                           }
    ...
    try:
        ...
        project_manager = ProjectManager(root_path=str(test_root_path), origin_project_path=origin_project_path, mode='old')
    ...
    try:
        ...
        """
            ...
            DEFAULT_ANALYSIS_SETTINGS = {
                ...
                "elements_quantity": [2, 6], # Example: [2 elements type 1, 6 elements type 3] #不同原件的数量
                "elements_type": [1, 3],     # Corresponding element types above 原件顺序
                "bounds":
        ...
        analysis_manager = AnalysisManager(
            ...
            group_id=next_group_id,  # Specify analysis group ID, or set to None for user input
            analysis_config=custom_analysis_setting,
            simple_size=10,  # Current round sample size
